$main.controller('yhGoodsStatController',yhGoodsStatController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.yhGoodsStat',{//商品管理
    	url:'/yhGoodsStat',
    	templateUrl:'template/yh_idp/yhGoodsStat.html?T='+Math.random(),
    	controller:'yhGoodsStatController'
    })
 ...
 * @return
 */
function yhGoodsStatController($scope,$http,T){
	...
	$scope.selectYhGoodsSoldList=function(){
		$http.post("yhSummary/selectYhGoodsSoldList.action",$scope.postData).success(function(data){
			if(data== undefined||data==null){
				data=[];
			}
