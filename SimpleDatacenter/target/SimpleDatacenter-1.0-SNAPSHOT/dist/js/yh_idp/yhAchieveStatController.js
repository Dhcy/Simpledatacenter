$main.controller('yhAchieveStatController',yhAchieveStatController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.yhAchieveStat',{
    	url:'/yhAchieveStat',
    	templateUrl:'template/yh_idp/yhAchieveStat.html?T='+Math.random(),
    	controller:'yhAchieveStatController'
    })
	
})
function yhAchieveStatController($scope,$http,T){
	...
	$scope.selectAchieveStatList=function(){
		$http.post("yhAchieveStat/selectAchieveStatList.action",$scope.postData).success(function(data){
			if(data== undefined||data==null){
				data=[];
			}
