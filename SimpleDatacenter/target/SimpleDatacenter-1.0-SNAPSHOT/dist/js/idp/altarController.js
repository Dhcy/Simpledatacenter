$main.controller('altarController',altarController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.altar',{//祭坛
    	url:'/altar',
    	templateUrl:'template/idp/altar.html?T='+Math.random(),
 ...
 * @return
 */
function altarController($scope,$http,T){
	...
	$scope.selectAltarList = function(){        
		$http.post("summary/selectAltarList.action",$scope.searchData).success(function(data){
