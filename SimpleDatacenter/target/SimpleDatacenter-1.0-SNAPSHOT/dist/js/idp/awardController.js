$main.controller('awardController',awardController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.awardcount',{//角色查询
    	url:'/awardcount',
    	templateUrl:'template/idp/award.html?T='+Math.random(),
 ...
 * @return
 */
function awardController($scope,$http,T){
	...
	$scope.selectAwardList = function(){        
		$http.post("summary/selectAwardSummaryList.action",$scope.searchData).success(function(data){
			console.log("悬赏");
			console.log(data);
