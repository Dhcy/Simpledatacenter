$main.controller('famController',famController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.famcount',{//角色查询
    	url:'/famcount',
    	templateUrl:'template/idp/fam.html?T='+Math.random(),
 ...
 * @return
 */
function famController($scope,$http,T){
