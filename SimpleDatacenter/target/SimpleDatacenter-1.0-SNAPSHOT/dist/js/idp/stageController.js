$main.controller('stageController',stageController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.stagecount',{//角色查询
    	url:'/stagecount',
    	templateUrl:'template/idp/stage.html?T='+Math.random(),
 ...
 * @return
 */
function stageController($scope,$http,T){
	...
	$scope.selectStageList = function(){        
		$http.post("summary/selectStageList.action",$scope.searchData).success(function(data){
			console.log("关卡");
			console.log(data);
