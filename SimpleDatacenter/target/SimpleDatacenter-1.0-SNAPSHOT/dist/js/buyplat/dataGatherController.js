function dataGatherController($scope,$http,T){
    $scope.panel_1 = {
        'model': 'table',
        'channelList': '',
        'gameList': '',
    ...
    $scope.getGameList = function () {
        $http.post("game/getUserGameList.action",{"projectid" : -1}).success(function(data){
            ...
            //console.log($scope.panel_1.gameList);
    ...
    $scope.searchData=function(){
        ...
        $http.post("buyplat/selectBuyPlatSummary.action",$scope.postData).success(function(data){
