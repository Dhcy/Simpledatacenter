function dataQueryController($scope,$http,T){
    $scope.panel_1 = {
        'model': 'table',
        'channelList': '',
        'gameList': '',
    ...
    $scope.searchData=function(){
    	...
    	$http.post("buyplat/selectBuyPlatDataQuery.action",$scope.postData).success(function(data){
            $scope.panel_1.dataList_1.data = data.items;
            $scope.panel_1.gather = data;
        });
    }
    //显示
