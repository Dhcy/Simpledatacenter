...
/**
 *  灯塔数据
 * @ClassName: YhLightHouceDataMapper
 * @Description: TODO
 * @author hwj
 * @date 2018-5-14 下午01:18:52
 */
public interface YhLightHouceDataMapper {
	/**
	 * 每个时间段每个环节的次数（成功跟失败）
	 ...
	 * @author hwj
	 * @date 2018-5-14 下午01:30:58
	 */
	public List<YhLightHouceData> selectPerLinkCntForHour(BaseSearchData searchData);
	/**
	 * 登录成功转化率
