 ...
 */
public interface PlayersRetentionMapper {
	/**
	 ...
	 * @date 2016年3月15日 下午5:32:27
	 */
	List<PlayersRetention> selectChannelRetentionOfNewUser (BaseSearchData searchData);
