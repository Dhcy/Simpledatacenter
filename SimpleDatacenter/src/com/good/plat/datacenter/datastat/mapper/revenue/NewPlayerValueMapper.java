 ...
 */
public interface NewPlayerValueMapper {
	/**
	 ...
	 */
	List<NewPlayerValue> selectXdaysAvgContributionList (BaseSearchData searchData);
	 ...
	 */
	List<NewPlayerValue> exportXdaysAvgContributionList (BaseSearchData searchData);
	 ...
	 */
	List<NewPlayerValue> selectSimpleDayPayMoneyList(BaseSearchData searchData);
	 ...
	 */
	List<NewPlayerValue> selectPerDayTotalPayMoneyList(BaseSearchData searchData);
