...
public interface IncomeDataMapper {
	 ...
	 */
	List<IncomeData> selectLevelIncomeNumDistribution (BaseSearchData searchData);
	 ...
	 */
	List<IncomeData> exportLevelIncomeNumDistribution (BaseSearchData searchData);
	 ...
	 */
	List<IncomeData> selectLevelChargePlayerNumDistribution (BaseSearchData searchData);
	 ...
	 */
	List<IncomeData> exportLevelChargePlayerNumDistribution (BaseSearchData searchData);
	 ...
	 */
	List<IncomeData> selectLocationIncomeDistribution (BaseSearchData searchData);
	 ...
	 */
	List<IncomeData> exportLocationIncomeDistribution (BaseSearchData searchData);
