$main.controller('illusStatController',illusStatController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.illusStat',{
    	url:'/illusStat',
    	templateUrl:'template/idp/illusStat.html?T='+Math.random(),
    	controller:'illusStatController'
    })
 ...
 * @return
 */
function illusStatController($scope,$http,T){
	...
	$scope.selectIllusLuckNumList = function(){        
		$http.post("summary/selectIllusLuckNumList.action",$scope.postData).success(function(data){
			if(data== undefined||data==null){
				data=[]
			}
