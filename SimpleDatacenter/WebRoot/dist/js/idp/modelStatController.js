$main.controller('modelStatController',modelStatController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.modelStat',{
    	url:'/modelStat',
    	templateUrl:'template/idp/modelStat.html?T='+Math.random(),
    	controller:'modelStatController'
    })
 ...
 * @return
 */
function modelStatController($scope,$http,T){
	...
	$scope.selectVowStatList = function(){        
		$http.post("summary/selectModelStatList.action",$scope.postData).success(function(data){
			if(data== undefined||data==null){
				data=[]
			}
