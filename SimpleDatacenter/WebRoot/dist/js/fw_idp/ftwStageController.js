$main.controller('ftwStageController',ftwStageController)
$main.config(function($stateProvider, $urlRouterProvider){
	$stateProvider.state('main.indpd.ftwstagecount',{//关卡统计
    	url:'/ftwstagecount',
    	templateUrl:'template/fw_idp/ftwstage.html?T='+Math.random(),
    	controller:'ftwStageController'
    })
 ...
 * @return
 */
function ftwStageController($scope,$http,T){
	...
	$scope.selectStageList = function(){        
		$http.post("fwSummary/selectFtwStageList.action",$scope.searchData).success(function(data){
